...
Remove-Item (Join-Path $PSScriptRoot .\src\FunctionalTest.runsettings) -Force -ErrorAction SilentlyContinue
...
$runSettingsDocument.Save((Join-Path $PSScriptRoot .\src\FunctionalTest.runsettings))